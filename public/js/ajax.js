              ...
              for (var i = 0; i < student_list.length; i++) {
                 ...
                 Adate='';Bdate='';
                   if(student_list[i].bonafide_date)
                   {
                    ...
                    //link="http://frontlineschool.com/images/panchavati-logo.png";
                    var DOB='';
...
function printDiv(elem)
{
   ...
   // mywindow.document.write('<img src="http://frontlineschool.com/images/panchavati-logo.png" alt="gffffff">');
